...
@interface ProductMaksima ()

@end

@implementation ProductMaksima
...
- (void)viewDidLoad
{
    ...
    scrollPengharagaan.contentSize = CGSizeMake(200, 1500);
    scrollPengharagaan.showsVerticalScrollIndicator=NO;
...
- (void)requestFinished:(ASIFormDataRequest *)request
{
    ...
    NSDictionary *tempDict = [saldo objectAtIndex:0];
