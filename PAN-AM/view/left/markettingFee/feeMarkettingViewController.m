...
#import "feeMarkettingViewController.h"
#import "detailsFee.h"
@interface feeMarkettingViewController ()

@end

@implementation feeMarkettingViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
		...
		[cari setFrame:CGRectMake(48.5, 120, 223, 44)];
...
-(void)jumpP{
	...
	detailsFee *dt=[[detailsFee alloc]init];
	dt.navigationItem.hidesBackButton = YES;
	[self.navigationController pushViewController:dt animated:YES];
}
-(void)tampilkan{
	calwin=[[calendarPic alloc]init];
	
	UINavigationController *a=[[UINavigationController alloc]initWithRootViewController:calwin];
